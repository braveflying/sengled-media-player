...
public class RequestLivingTask extends AsyncTask<String,Void,List<Lives>> {
    ...
    private static final String imagePrefixPath= Const.AWS_BASE_URL+"/amazon-storage/screenshot/";
    private static final String imageSuffixPath="_big.jpg?size=640*360";
